...
const writeScript = (fn, code) => ({Cmd: ["sh", "start.sh", fn + ".js", code], AttachStderr: true, AttachStdout: true});
const runTests = (fn) => ({Cmd: ["jest", fn + ".test.js"], AttachStderr: true, AttachStdout: true});
