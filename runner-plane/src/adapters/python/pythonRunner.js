...
const writeScript = (fn, code) => ({Cmd: ["sh", "start.sh", fn + ".py", code], AttachStderr: true, AttachStdout: true});
const runTests = (fn) => ({Cmd: ["python3", fn + "_test.py", "-v"], AttachStderr: true, AttachStdout: true});



async function nodeRunner(fn, code, cb){
    let res = ""; 
